package com.ecarxclub.app.share;
...
public class ShareUtils {
     ...
     * 分享链接
     */
    public static void shareWeb(final Activity activity, String WebUrl, String title, String description,
        ...
        new ShareAction(activity)
                ...
                .setCallback(new UMShareListener() {
                    ...
                    public void onStart(SHARE_MEDIA share_media) {
                        ToastUtils.i("onStart","___"+share_media);
                    }
                    @Override
                    public void onResult(final SHARE_MEDIA share_media) {
                        ToastUtils.i("","分享onResult "+share_media.name());
                    ...
                    public void onError(final SHARE_MEDIA share_media, final Throwable throwable) {
                        if (throwable != null) {
                            ToastUtils.i("onError","__throw____"+throwable.getMessage());
    ...
    //分享图片
    public static void shareImg(Activity activity,String imgUrl,SHARE_MEDIA platform){
        UMImage image = new UMImage(activity, imgUrl);//网络图片
        new ShareAction(activity) .setPlatform(platform).withText("咖豆派").withMedia(image).share();
    }
}
