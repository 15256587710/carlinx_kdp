...
import com.ecarxclub.app.utils.picker.AddressPicker;
...
public class AddressPickTask extends AsyncTask<String, Void, ArrayList<Province>> {
    ...
    protected ArrayList<Province> doInBackground(String... params) {
        ...
        try {
            ...
            Gson gson = new Gson();
            data = gson.fromJson(json, new TypeToken<List<Province>>() {
            }.getType());
//            data.addAll(JSON.parseArray(json, Province.class));
    ...
    protected void onPostExecute(ArrayList<Province> result) {
        ...
        if (result.size() > 0) {
            ...
            if (selectedCity.equals(selectedCounty)) {
                picker.setSelectedItem(selectedProvince, selectedCity, "AA");
            }else {
