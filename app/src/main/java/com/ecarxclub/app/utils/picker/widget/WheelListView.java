...
import com.ecarxclub.app.utils.ConvertUtils;
...
public class WheelListView extends ListView implements ListView.OnScrollListener, View.OnTouchListener,
    ...
    public static final int TEXT_COLOR_FOCUS = 0XFF333333;//0XFF0288CE
    public static final int TEXT_COLOR_NORMAL = 0XFF999999;//0XFFBBBBBB
    ...
    public void onGlobalLayout() {
        ...
        if (childCount > 0 && itemHeightPixels == 0) {
            ...
            LogUtils.verbose("itemHeightPixels=" + itemHeightPixels);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                LogUtils.verbose("press down: currentPosition=" + currentPosition);
                break;
            case MotionEvent.ACTION_UP:
                LogUtils.verbose("press up: currentItem=" + getSelectedItem());
                break;
        }
        return false;
    }
