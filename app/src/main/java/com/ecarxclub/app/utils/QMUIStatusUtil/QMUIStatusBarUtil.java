package com.ecarxclub.app.utils.QMUIStatusUtil;
 ...
 * @date 2016-03-27
 */
public class QMUIStatusBarUtil {
    ...
    public static void translucent(Activity activity, @ColorInt int colorOn5x) {
        ...
        // 小米和魅族4.4 以上版本支持沉浸式
        if (QMUIDeviceUtil.isMeizu() || QMUIDeviceUtil.isMIUI()) {
...
//            }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        return QMUIDeviceUtil.isMIUIV5() || QMUIDeviceUtil.isMIUIV6() ||
                QMUIDeviceUtil.isMIUIV7() || QMUIDeviceUtil.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(QMUIDeviceUtil.isZUKZ1() || QMUIDeviceUtil.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (QMUIDeviceUtil.isTablet(context)
                && sStatusbarHeight > QMUIDisplayUtil.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
            //状态栏高度大于25dp的平板，状态栏通常在下方
            sStatusbarHeight = 0;
        } else {
            if (sStatusbarHeight <= 0
                    || sStatusbarHeight > QMUIDisplayUtil.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP * 2)) {
